...
const Hero = () => {
  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div
        className={`max-w-7xl mx-auto ${styles.paddingX} pt-32 flex flex-col lg:flex-row items-center lg:items-start gap-12`}
      >
      ...
      <div className={`absolute inset-0 top-[120px]  max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5 justify-end`}>
        <div className={styles.profilePicContainer} flex-shrink-0 relative right-8>
          <img 
            src={profilePhoto} 
            alt="Profile" 
